    ...
    for group in grouped_events:
        ...
        for i, event in enumerate(group):
            ...
            if i == 0:
                ...
                interval_moves = [
                    m for m in move_events if prev_event["time"] < m["time"] < event["time"]
                ]
        ...
        final_px, final_py = get_clamped_pos(
            (current_cam_x - 0.5) * 2, (0.5 - current_cam_y) * 2, scale_val
        )
